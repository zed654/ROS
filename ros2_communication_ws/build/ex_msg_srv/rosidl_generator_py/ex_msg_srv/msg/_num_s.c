...
bool ex_msg_srv__msg__num__convert_from_py(PyObject * _pymsg, void * _ros_message)
{
  // check that the passed message is of the expected Python class
  {
    ...
    assert(strncmp(
        "ex_msg_srv.msg._num.Num",
        full_classname_dest, 23) == 0);
  }
  ex_msg_srv__msg__Num * ros_message = _ros_message;
  {  // num
...
PyObject * ex_msg_srv__msg__num__convert_to_py(void * raw_ros_message)
{
  ...
  {
    PyObject * pymessage_module = PyImport_ImportModule("ex_msg_srv.msg._num");
