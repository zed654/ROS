...
#include "ex_msg_srv/srv/add_three_ints__rosidl_typesupport_fastrtps_cpp.hpp"
...
{
  auto typed_message =
    static_cast<const ex_msg_srv::srv::AddThreeInts_Request *>(
    untyped_ros_message);
...
{
  auto typed_message =
    static_cast<ex_msg_srv::srv::AddThreeInts_Request *>(
    untyped_ros_message);
...
template<>
ROSIDL_TYPESUPPORT_FASTRTPS_CPP_EXPORT_ex_msg_srv
const rosidl_message_type_support_t *
get_message_type_support_handle<ex_msg_srv::srv::AddThreeInts_Request>()
{
  return &ex_msg_srv::srv::typesupport_fastrtps_cpp::_AddThreeInts_Request__handle;
}
...
{
  auto typed_message =
    static_cast<const ex_msg_srv::srv::AddThreeInts_Response *>(
    untyped_ros_message);
  return cdr_serialize(*typed_message, cdr);
}
...
{
  auto typed_message =
    static_cast<ex_msg_srv::srv::AddThreeInts_Response *>(
    untyped_ros_message);
  return cdr_deserialize(cdr, *typed_message);
}
...
{
  return &ex_msg_srv::srv::typesupport_fastrtps_cpp::_AddThreeInts_Response__handle;
}
...
{
  return &ex_msg_srv::srv::typesupport_fastrtps_cpp::_AddThreeInts__handle;
}
