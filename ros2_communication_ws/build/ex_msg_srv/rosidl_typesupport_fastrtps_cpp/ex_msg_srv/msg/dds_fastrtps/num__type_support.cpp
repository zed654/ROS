...
#include "ex_msg_srv/msg/num__rosidl_typesupport_fastrtps_cpp.hpp"
...
{
  auto typed_message =
    static_cast<const ex_msg_srv::msg::Num *>(
    untyped_ros_message);
...
{
  auto typed_message =
    static_cast<ex_msg_srv::msg::Num *>(
    untyped_ros_message);
...
{
  return &ex_msg_srv::msg::typesupport_fastrtps_cpp::_Num__handle;
}
