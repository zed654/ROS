...
#include <stddef.h>
#include "ex_msg_srv/msg/num__rosidl_typesupport_introspection_c.h"
...
static rosidl_typesupport_introspection_c__MessageMember Num__rosidl_typesupport_introspection_c__Num_message_member_array[1] = {
  {
    ...
    offsetof(ex_msg_srv__msg__Num, num),  // bytes offset in struct
    NULL,  // default value
...
static const rosidl_typesupport_introspection_c__MessageMembers Num__rosidl_typesupport_introspection_c__Num_message_members = {
  "ex_msg_srv__msg",  // message namespace
  "Num",  // message name
  1,  // number of fields
  sizeof(ex_msg_srv__msg__Num),
...
ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_introspection_c, ex_msg_srv, msg, Num)() {
