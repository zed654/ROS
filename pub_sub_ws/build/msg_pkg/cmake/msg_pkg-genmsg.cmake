...
message(STATUS "msg_pkg: 1 messages, 0 services")

set(MSG_I_FLAGS "-Imsg_pkg:/home/chp/ros/tutorial/pub_sub_ws/src/msg_pkg/msg;-Istd_msgs:/opt/ros/kinetic/share/std_msgs/cmake/../msg")
...
get_filename_component(_filename "/home/chp/ros/tutorial/pub_sub_ws/src/msg_pkg/msg/msg_data.msg" NAME_WE)
add_custom_target(_msg_pkg_generate_messages_check_deps_${_filename}
  COMMAND ${CATKIN_ENV} ${PYTHON_EXECUTABLE} ${GENMSG_CHECK_DEPS_SCRIPT} "msg_pkg" "/home/chp/ros/tutorial/pub_sub_ws/src/msg_pkg/msg/msg_data.msg" ""
)
...
_generate_msg_cpp(msg_pkg
  "/home/chp/ros/tutorial/pub_sub_ws/src/msg_pkg/msg/msg_data.msg"
  "${MSG_I_FLAGS}"
  ""
...
if(genpy_INSTALL_DIR AND EXISTS ${CATKIN_DEVEL_PREFIX}/${genpy_INSTALL_DIR}/msg_pkg)
  install(CODE "execute_process(COMMAND \"/usr/bin/python\" -m compileall \"${CATKIN_DEVEL_PREFIX}/${genpy_INSTALL_DIR}/msg_pkg\")")
  # install generated code
  install(
